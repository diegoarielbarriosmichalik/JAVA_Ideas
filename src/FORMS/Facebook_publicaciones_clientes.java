...
public class Facebook_publicaciones_clientes extends javax.swing.JFrame {

    public Facebook_publicaciones_clientes() {
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Clientes");
        setIconImage(new ImageIcon(getClass().getResource("/Imagenes/icon.png")).getImage());
        Metodos.Facebook_clientes_cargar_jtable(jTextField_buscar.getText());
    }
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        ...
        if ((evt.getKeyCode() == KeyEvent.VK_ENTER)) {
            this.setVisible(false);
            Metodos.Facebook_clientes_seleccionar();
            Facebook_publicaciones.jTextField_publicacion.requestFocus();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Facebook_publicaciones_clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
