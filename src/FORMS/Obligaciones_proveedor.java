...
public class Obligaciones_proveedor extends javax.swing.JFrame {
...
//        Metodos.Clientes_cargar_jtable(jTextField_buscar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Obligaciones_proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
